  ...
  return (
    <div className="rounded-3xl shadow-[-4px_0_15px_#5b979d] p-6 mx-auto flex flex-col justify-center items-center my-[4rem] w-[90%] md:w-fit text-center">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        >
          <FaGithub size={28} />
          <span className="font-poppins text-lg md:text-xl">GitHub</span>
        </a>
        ...
        >
          <FaLinkedin size={28} />
          <span className="font-poppins text-lg md:text-xl">LinkedIn</span>
        </a>
        ...
        >
          <FaInstagram size={28} />
          <span className="font-poppins text-lg md:text-xl">Instagram</span>
        </a>
        ...
        >
          <MdEmail size={28} />
          <span className="font-poppins text-lg md:text-xl">E-mail</span>
        </a>
      </div>
    </div>
  );
